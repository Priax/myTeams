...
** (list threads, create reply...) you MUST be subscribed to the team.
*/
...
** When you logout(/logout) you should also receive the event before quitting.
...
**/
int client_print_users(char const *user_uuid, char const *user_name,
    int user_status);

/**
** @brief Must be called when you requested a list of teams from the server
** ex: asking the teams you are subscribed to or available teams in a domain
